...
add_image_size( 'members-large', 250, 250, true );
...
function wp_bootstrap_register_sidebars() {
    register_sidebar(array(
    	'id' => 'index1',
    	'name' => 'Home first feature',
    	'description' => 'Used on top of the homepage page template.',
    	'before_widget' => '<div class="row-fluid"> <div class="col-md-12 welcome">',
    	'after_widget' => '</div></div>',
    	'before_title' => '<h3>Welcome to LIS</h3><h4>',
    	'after_title' => '</h4>',
    ));

    register_sidebar(array(
    	'id' => 'index2',
    	'name' => 'Home bottom feature',
    	'description' => 'Used on bottom of the homepage page template.',
    	'before_widget' => '<div class="row-fluid"> <div class="col-md-12 timeline">',
    	'after_widget' => '</div>',
    ));
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script(  'equalHeight', 
      get_template_directory_uri() . '/library/js/jquery.sameheight.min.js', 
      array('jquery'), 
      '1.2' );
...
class Walker_Show_Excerpt extends Walker_Page {
        function start_el(&$output, $page, $depth, $args, $current_page) {
                ...
                if(!empty($page->post_excerpt))
                    ...
                    $page_excerpt = kcr_get_simple_excerpt($page->post_content);
                ...
                $output .= $indent . '<li class="' . $css_class . '"><h3><i class="fa fa-level-up"></i><a href="' . get_permalink($page->ID) . '">' . $link_title . "</a></h3><div class='resume'>{$page_excerpt}</div>";
                //End Modification
...
function kcr_get_simple_excerpt($content, $size = 70){
    ...
    for($i = 0; $i < $size && $i <$content_size; $i++)
        $the_excerpt .= $content[$i]." ";
     
    return ($content_size > $size ? trim(trim($the_excerpt), '.').'...' : trim($the_excerpt));
}
...
//custom post Members
require_once('members-type.php');

// metaboxes
require_once ('library/metabox/functions.php');

// bootstrap-shortcodes
require_once ('library/bootstrap_shortcodes/bootstrap-shortcodes.php');
