...
function wp_bootstrap_theme_support() {
	...
	register_nav_menus(                      // wp3+ menus
		array( 
			...
			'second_nav' => 'The Secundary Menu' // secondary nav in top
		)
	);	
}
...
function wp_bootstrap_second_nav() { 
	// display the wp3 menu if available
    wp_nav_menu(
    	array(
    		...
    		'container_class' => 'second_nav clearfix', /* container class */
    		'fallback_cb' => 'wp_bootstrap_second_nav_fallback' /* menu fallback */
    	)
	);
}
...
function wp_bootstrap_second_nav_fallback() { 
